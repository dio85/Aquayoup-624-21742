...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "xx * Options de depart: lvl & lieu de d�part dans sa faction      NPC 15000386    xx");
    TC_LOG_INFO("server.worldserver", "xx * Guilde par defaut a la cr�ation d'un perso                                   xx");
    TC_LOG_INFO("server.worldserver", "xx * FunRate (joueur) stat,heal,dps,temps de cast,power...                        xx");
    TC_LOG_INFO("server.worldserver", "xx * DressNPC (creature_template_outfits , modelid1 a modelid4 en n�gatif)        xx");
    TC_LOG_INFO("server.worldserver", "xx * NPC_AI_xxx Script de classes et autres pour mobs classiques                  xx");
    TC_LOG_INFO("server.worldserver", "xx * Action suite a un �v�nement Joueur(Apprentissage, connexion, levelup, zone...xx");
    TC_LOG_INFO("server.worldserver", "xx                                                                                xx");
